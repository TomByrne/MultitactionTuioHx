package multitaction.tuio.view.starling.display.touches.old;
import imagsyd.deprecated.touch.TouchManager;
import multitaction.tuio.view.starling.display.touches.old.TouchesDisplayView;
import multitaction.tuio.view.starling.display.touches.old.touch.TouchPoint;
import multitaction.tuio.view.starling.display.touches.old.touch.TouchPointMediator;
